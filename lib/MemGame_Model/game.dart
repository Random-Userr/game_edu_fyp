...
import 'package:game_edu_fyp/MemGame_Model/card_item.dart';
import 'package:game_edu_fyp/MemGameUtils/icons.dart';
...
class Game {
  ...
  IconData _getRandomCardIcon() {
    ...
    IconData icon;
    do {
      icon = cardIcons[random.nextInt(cardIcons.length)] as IconData;
